 ...
 * Generated at     :: segunda-feira, 27 de março de 2023, 17:02 Hora Coordenada Universal
  ...
  "classes/Apis/location.js"(exports2, module2) {
    ...
    var location_apis = class {
      constructor() {
        ...
        __publicField(this, "prepare_lbs_parameters_for_requesition", (keyTag, scope, dataType) => {
          if (keyTag === void 0) {
            return;
          }
...
var require_soc = __commonJS({
  "classes/decoding_files/soc.js"(exports2, module2) {
    var smart_one_c_message2 = class {
    ...
    try {
      ...
      for await (let stu_message of file_content) {
        ...
        if (device[0].tags.find((tag) => tag.key === "TYPE" && tag.value === "SOC")) {
          console.log("SOC");
          const smart_one_c_message2 = new soc_messages();
          let decoded_code;
          decoded_code = smart_one_c_message2.decode(stu_message, esn_value);
          decoded_code !== void 0 && await tago_func.insert_on_tago(decoded_code, account_tago, Device, device[0].id, stu_message);
...
async function Decoding_analysis(context, scope) {
  try {
    ...
    if (scope.length !== 0) {
      ...
      const tago_func2 = new tago_functions(account);
      let device_id = await identify_device_on_tago();
      let decoded_code = await mqtt_message.decode(scope);
      decoded_code !== void 0 && await tago_func2.insert_on_tago(decoded_code, Device, device_id[0].id, decoded_code);
      process.kill(process.pid, "SIGINT");
    }
