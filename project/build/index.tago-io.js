 ...
 * -------------------
 * Generated by     :: kaique
 * Generated at     :: sexta-feira, 3 de fevereiro de 2023 17:39 Horário Universal Coordenado
...
var require_ftp_and_tago_functions = __commonJS({
  "classes/ftp_and_tago_functions.js"(exports2, module2) {
    ...
    var ftp_and_tago_function = class {
      ...
      async insert_on_tago(decoded_code, account_tago, Device2, device_id) {
...
var require_soc = __commonJS({
  "classes/soc.js"(exports2, module2) {
    ...
    var smart_one_c_message = class extends ftp_and_tago_function {
      ...
      Decode_default_message(hexa_code, esn_value, file_content) {
        const latitude = this.decode_lat(hexa_code.substring(2, 8));
        const longitude = this.decode_lng(hexa_code.substring(8, 14));
        let object_with_datas_to_insert_on_tago = { variable: "ESN", value: esn_value, location: { type: "Point", coordinates: [longitude, latitude] }, metadata: { message_type: "00", device_type: "SOC", xml: file_content } };
        let current_byte = "";
        ...
        for (let i = 0; i < hexa_code.length; i++) {
          ...
          if (current_byte.length === 2) {
            ...
            let value_of_each_bit = { "002": { batery: 0 }, "012": { batery: 1 }, "003": { gps_data: 0 }, "013": { gps_data: 1 }, "014": { missed_input1: true }, "015": { missed_input2: true }, "006": "", "016": "", "007": () => {
              let binary_code = current_byte_2_bin[6] + current_byte_2_bin[7];
              ...
              let bin_2_decimal = parseInt(binary_code, 2);
              object_with_datas_to_insert_on_tago["metadata"]["gps_fail_counter"] = bin_2_decimal;
            }, "700": { input_1_change: false }, "710": { input_1_change: true }, "701": { input_1_state: false }, "711": { input_1_state: true }, "702": { input_2_change: false }, "712": { input_2_change: true }, "703": { Input_2_state: false }, "713": { Input_2_state: true }, "704": "", "714": "", "705": "", "715": "", "706": "", "716": "", "707": () => {
              let binary_code = current_byte_2_bin[4] + current_byte_2_bin[5] + current_byte_2_bin[6] + current_byte_2_bin[7];
              let bin_2_decimal = parseInt(binary_code, 2);
              return object_with_datas_to_insert_on_tago["metadata"]["sub_type"] = bin_2_decimal;
            }, "717": () => {
              let binary_code = current_byte_2_bin[4] + current_byte_2_bin[5] + current_byte_2_bin[6] + current_byte_2_bin[7];
              let bin_2_decimal = parseInt(binary_code, 2);
              return object_with_datas_to_insert_on_tago["metadata"]["sub_type"] = bin_2_decimal;
            }, "803": { vibration_state_changed: 0 }, "813": { vibration_state_changed: 1 }, "804": { vibration_Unit: 0 }, "814": { vibration_Unit: 1 }, "805": { type_location: 0 }, "815": { type_location: 1 }, "806": { in_motion: false }, "816": { in_motion: true }, "807": { gps_accuracy: 0 }, "817": { gps_accuracy: 1 } };
      ...
      Decode_truncate_message(hexa_code, esn_value, file_content) {
      ...
      Decode_type3_message(hexa_code, esn_value, file_content) {
        ...
        function subtype() {
          ...
          let response;
          console.log(hexa_code, byte_that_countains_the_subtype_of_message, hex_2_bin, hex_2_bin.substring(2, 8), parseInt(hex_2_bin.substring(2, 8), 2));
    ...
    try {
      ...
      for await (let stu_message of file_content) {
        ...
        if (device[0].tags.find((tag) => tag.key === "TYPE" && tag.value === "SOC")) {
          ...
          decoded_code !== void 0 && await smart_one_c_message.insert_on_tago(decoded_code, account_tago, Device, device[0].id);
