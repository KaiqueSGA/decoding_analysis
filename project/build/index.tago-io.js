 ...
 * -------------------
 * Generated by     :: kaique
 * Generated at     :: segunda-feira, 10 de abril de 2023 18:18 Horário Universal Coordenado
      ...
      constructor(esn2) {
        ...
        __publicField(this, "get_message_origin", (tmpSTR) => {
          ...
          if (tmpSTR === null || tmpSTR === "ERROR") {
            if (this.esn.metadata.raw_data.includes("mac0")) {
              tmpSTR = "MAC";
            } else if (this.esn.metadata.raw_data.includes("lbs0")) {
              tmpSTR = "LBS";
            }
          }
