 ...
 * Generated at     :: quinta-feira, 31 de agosto de 2023 às 14:47 Hora Coordenada Universal
 * Machine          :: LAPTOP-IUM85ULR <win32> - Node.js v18.17.0
...
var require_location = __commonJS({
  "classes/Apis/location.js"(exports2, module2) {
    ...
    var location_apis = class {
      prepare_mac_parameterers_for_requisition = (wifi_fields, esn2) => {
      ...
      prepare_lbs_parameters_for_requesition = (keyTag, esn2, dataType) => {
        if (keyTag === void 0) {
          return;
        }
      ...
      get_address_through_coordinates = async (latitude, longitude) => {
      ...
      get_coordinates_through_mac_datas = async (wifi_fields, esn2) => {
      ...
      get_coordinates_through_lbs_datas = async (lbs_fields, esn2, data_type) => {
        try {
