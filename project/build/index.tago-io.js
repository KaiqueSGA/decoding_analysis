 ...
 * Generated at     :: quarta-feira, 10 de maio de 2023, 17:58 Hora Coordenada Universal
 * Machine          :: LAPTOP-IUM85ULR <win32> - Node.js v14.17.1
=======
 * Generated by     :: kaique
 * Generated at     :: sexta-feira, 5 de maio de 2023, 15:12 Hora Coordenada Universal
...
var require_location = __commonJS({
  "classes/Apis/location.js"(exports2, module2) {
    ...
    var location_apis = class {
      constructor() {
        __publicField(this, "prepare_mac_parameterers_for_requisition", (wifi_fields, esn2) => {
          let wifi_parameters_list = new Array();
          if (wifi_fields === void 0) {
            return;
          } else {
            wifi_fields.forEach((key) => {
              if (!esn2.metadata[key]) {
                return;
              }
              let wifi_fields_array = esn2.metadata[key].split(",");
        ...
        __publicField(this, "prepare_lbs_parameters_for_requesition", (keyTag, esn2, dataType) => {
          if (keyTag === void 0) {
            return;
          }
          ...
          keyTag.forEach((key) => {
            ...
            let arrayFieldsLbs = esn2.metadata[key].split(",");
        ...
        __publicField(this, "get_coordinates_through_mac_datas", async (wifi_fields, esn2) => {
          let list = this.prepare_mac_parameterers_for_requisition(wifi_fields, esn2);
          try {
        ...
        __publicField(this, "get_coordinates_through_lbs_datas", async (lbs_fields, esn2, data_type) => {
          try {
            let list = this.prepare_lbs_parameters_for_requesition(lbs_fields, esn2, data_type);
...
// classes/decoding_files/stx.js
var require_stx = __commonJS({
  "classes/decoding_files/stx.js"(exports2, module2) {
    var location2 = require_location();
    var stx_message = class {
      constructor() {
        ...
        __publicField(this, "decode_lat", (file_content, cardinal_position) => {
          let hexadecimal_lat = file_content.substring(0, 6);
          let integer_lat = String(parseInt(hexadecimal_lat, 16));
          let final_lat = integer_lat / 1e4;
        ...
        __publicField(this, "decode_binary_values", (file_content) => {
          ...
          if (byte8.substring(0, 1) === "0") {
            values_object.battery_change = false;
          } else {
            values_object.battery_change = true;
          }
          let byte9 = file_content.substring(16, 18);
          values_object.lastSPD = parseInt(byte9, 16);
          if (values_object.mode === 2) {
            values_object.jamm = "NO JAMMING";
          } else if (values_object.mode === 3) {
            values_object.jamm = "JAMMING DETECTED";
          }
          return values_object;
        });
      }
      async decode(file_content, esn_value, unixtime) {
        const location_functions = new location2();
...
// classes/decoding_files/soc.js
var require_soc = __commonJS({
  "classes/decoding_files/soc.js"(exports2, module2) {
    var smart_one_c_message = class {
      ...
      Decode_default_message(hexa_code, esn_value, unix_time) {
        ...
        let object_with_datas_to_insert_on_tago = { variable: "ESN", value: esn_value, location: { type: "Point", coordinates: [longitude, latitude] }, metadata: { message_type: 0, device_type: "SOC", url_pin: { url: `https://www.google.com/maps/search/?api=1&query=${latitude},${longitude}`, alias: `Open map at ${latitude},${longitude}` } } };
        let current_byte = "";
    ...
    module2.exports = smart_one_c_message;
  }
});

// classes/decoding_files/mqtt.js
var require_mqtt = __commonJS({
  "classes/decoding_files/mqtt.js"(exports2, module2) {
    var location2 = require_location();
    var mqtt_message = class {
      constructor(esn2) {
        __publicField(this, "mapLINK", "https://www.google.com/maps/search/?api=1&query=");
        __publicField(this, "coordinates_origin");
        ...
        __publicField(this, "fncRMC", async (tmpSTR) => {
          const location_functions = new location2();
          tmpSTR = tmpSTR.replace("*", ",");
          var tmpSPLIT = tmpSTR.split(",");
          if (tmpSPLIT[12] == "N") {
            ...
            if (coordinates.lat === 0 || coordinates.lng === 0) {
              let tmpLAT2 = tmpSPLIT[3];
              let tmpLON2 = tmpSPLIT[5];
              let tmpNS2 = tmpSPLIT[4];
              var tmpEW = tmpSPLIT[6];
              tmpLAT2 = this.fncGPS166(tmpLAT2);
              if (tmpNS2 == "S") {
                coordinates.lat = "-" + tmpLAT2;
              }
              tmpLON2 = this.fncGPS166(tmpLON2);
              if (tmpEW == "W") {
                coordinates.lng = "-" + tmpLON2;
              }
            }
        ...
        __publicField(this, "get_message_origin", (tmpSTR) => {
          ...
          if (tmpSTR === null || tmpSTR === "ERROR") {
            tmpSTR = this.coordinates_origin;
          }
        ...
        __publicField(this, "decode", async (scope) => {
          ...
          if (values_array.find((item) => item.includes("rmc")) !== void 0) {
            let field_key2 = values_array.find((item) => item.includes("rmc")).split(",")[0].trim();
            let field_value2 = values_array.find((item) => item.includes("rmc")).replace(field_key2 + ",", "").trim();
            await this.fncRMC(field_value2);
          }
          if (values_array.find((item) => item.includes("psti20")) !== void 0) {
            let field_key2 = values_array.find((item) => item.includes("psti20")).split(",")[0].trim();
            let field_value2 = values_array.find((item) => item.includes("psti20")).replace(field_key2 + ",", "").trim();
            this.get_message_origin(field_value2);
          }
...
var require_tago = __commonJS({
  "classes/Apis/tago.js"(exports2, module2) {
    var tago_functions2 = class {
      ...
      async insert_on_tago(decoded_code, Device2, device_id) {
...
var require_ftp = __commonJS({
  "classes/Apis/ftp.js"(exports2, module2) {
    var ftp_methods2 = class {
    ...
    module2.exports = ftp_methods2;
  }
});

// index.js
var { Analysis, Account, Utils, Device } = require("@tago-io/sdk");
    ...
    try {
      ...
      for await (let stu_message of file_content) {
        ...
        if (device[0].tags.find((tag) => tag.key === "TYPE" && tag.value === "SOC")) {
          ...
          decoded_code !== void 0 && (decoded_code.metadata.address = await location_functions.get_address_through_coordinates(decoded_code.metadata.lat, decoded_code.metadata.lon));
          decoded_code !== void 0 && (decoded_code.time = time_stamp);
          decoded_code !== void 0 && await tago_function.insert_on_tago(decoded_code, Device, device[0].id);
          decoded_code !== void 0 && await ftp_method.delete_file_from_ftp();
