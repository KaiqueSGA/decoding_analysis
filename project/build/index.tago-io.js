    ...
    var stx_message = class {
      constructor() {
        ...
        __publicField(this, "decode_lat", (file_content, cardinal_position) => {
          ...
          let first_2_numbers_of_coordinate = cardinal_position === "south" ? "-" + lat.substring(0, 2) : lat.substring(0, 2);
        ...
        __publicField(this, "decode_lng", (file_content, cardinal_position) => {
          ...
          let first_2_numbers_of_coordinate = cardinal_position === "weast" ? "-" + lng.substring(0, 2) : lng.substring(0, 2);
