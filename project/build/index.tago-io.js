 ...
 * -------------------
 * Generated by     :: kaique
 * Generated at     :: sexta-feira, 1 de setembro de 2023, 17:28 Hora Coordenada Universal
...
// index.js
var { Analysis, Account, Utils, Device, Resources, Services } = require("@tago-io/sdk");
    ...
    if (scope.length !== 0) {
      ...
      const identify_device_on_tago = async () => {
        ...
        if (device_obj.length === 0) {
          ...
          return await resources.devices.list({ page: 1, filter });
        }
        ;
      };
      ...
      decoded_code !== void 0 && await tago_func.insert_on_tago(decoded_code, Device, device_id[0].id);
      process.kill(process.pid, "SIGINT");
    }
