 ...
 * -------------------
 * Generated by     :: kaique
 * Generated at     :: quinta-feira, 16 de março de 2023 18:35 Horário Universal Coordenado
...
var require_ftp_and_tago_functions = __commonJS({
  "classes/ftp_and_tago_functions.js"(exports2, module2) {
    ...
    var ftp_and_tago_function = class {
      ...
      async insert_on_tago(decoded_code, account_tago, Device2, device_id, stu_message) {
...
var require_stx = __commonJS({
  "classes/stx.js"(exports2, module2) {
    var { default: ConsoleService } = require("@tago-io/sdk/out/modules/Services/Console");
    ...
    var stx_message = class extends ftp_and_tago_function {
      constructor(xml_file_name, ftp_connection) {
        ...
        __publicField(this, "decode_binary_values", (file_content) => {
          ...
          let value_of_each_byte = {
            ...
            "3": (byte) => {
              byte === "0" ? object_array.push({ mode: "normal" }) : object_array.push({ mode: "jamming" });
            }
          };
          for (let i = 0; i <= 3; i++) {
      ...
      async insert_on_tago(decoded_code, account_tago, Device2, esn_value) {
        try {
          let filter = {
            tags: [{ key: "ESN", value: esn_value }]
          };
          const searching_device_on_tago = await account_tago.devices.list({ page: 1, filter });
          if (searching_device_on_tago === void 0 || searching_device_on_tago === null || searching_device_on_tago.length === 0) {
            return `Dispositivo que corresponde a ESN:${payload.value} n\xE3o existe.`;
          }
          ...
          const myDevice = new Device2({ token: device_token });
    ...
    try {
      ...
      for await (let stu_message of file_content) {
        ...
        if (device[0].tags.find((tag) => tag.key === "TYPE" && tag.value === "SOC")) {
          ...
          decoded_code !== void 0 && await stx_message.insert_on_tago(decoded_code, account_tago, Device, decoded_code.value);
