 ...
 * Generated at     :: quarta-feira, 29 de março de 2023, 11:46 Hora Coordenada Universal
  ...
  "classes/Apis/location.js"(exports2, module2) {
    ...
    var location_apis = class {
      constructor() {
        ...
        __publicField(this, "get_coordinates_through_lbs_datas", async (lbs_fields, scope, data_type) => {
          try {
      ...
      constructor() {
        ...
        __publicField(this, "decode_binary_values", (file_content) => {
          ...
          if (byte8.substring(0, 1) === "0") {
            object_array.push({ battery_change: false });
          } else {
            object_array.push({ battery_change: true });
          }
      ...
      constructor(esn2) {
        ...
        __publicField(this, "decode", async (scope) => {
          ...
          if (this.esn.location !== void 0) {
            ...
            if (this.esn.location !== void 0) {
              this.esn.location.lat = lbs_coordinates.lat;
              this.esn.location.lng = lbs_coordinates.lng;
            }
            ;
