 ...
 * Generated at     :: quinta-feira, 25 de maio de 2023, 18:36 Hora Coordenada Universal
  ...
  for await (let ftp_file of file_list) {
    try {
      ...
      for await (let stu_message of file_content) {
        ...
        if (!device && device[0].tags.find((tag) => tag.key === "TYPE" && tag.value === "SOC")) {
          console.log("SOC");
        ...
        } else if (!device && device[0].tags.find((tag) => tag.key === "TYPE" && tag.value === "STX")) {
          console.log("STX");
