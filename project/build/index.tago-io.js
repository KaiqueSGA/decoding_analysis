 ...
 * -------------------
 * Generated by     :: kaique
 * Generated at     :: sexta-feira, 10 de março de 2023 18:42 Horário Universal Coordenado
...
var require_soc = __commonJS({
  "classes/soc.js"(exports2, module2) {
    ...
    var smart_one_c_message = class extends ftp_and_tago_function {
      constructor(xml_file_name, ftp_connection) {
    ...
    var stx_message = class extends ftp_and_tago_function {
      ...
      decode(file_content, esn_value) {
        ...
        const catchLat = () => {
          ...
          let lat = parseInt(latHEX, 16);
          lat = String(lat);
          let tira2casasLat = ns === "Sul" ? "-" + lat.substring(0, 2) : lat.substring(0, 2);
        ...
        const catchLng = () => {
          ...
          lng = String(lng);
          let tira2casasLng = ew === "weast" ? "-" + lng.substring(0, 2) : lng.substring(0, 2);
...
async function Changing_algorithm(file_list, ftp_connection, account_tago) {
  ...
  for await (let ftp_file of file_list) {
    try {
      ...
      let file_content = await smart_one_c_message.get_file_content();
      ...
      for await (let stu_message of file_content) {
        ...
        if (device[0].tags.find((tag) => tag.key === "TYPE" && tag.value === "SOC")) {
          ...
          decoded_code !== void 0 && await smart_one_c_message.insert_on_tago(decoded_code, account_tago, Device, device[0].id, stu_message);
          decoded_code !== void 0 && await smart_one_c_message.delete_file_from_ftp();
