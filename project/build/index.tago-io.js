 ...
 * Generated at     :: segunda-feira, 20 de março de 2023, 11:52 Hora Coordenada Universal
    ...
    try {
      ...
      for await (let stu_message of file_content) {
        ...
        if (device[0].tags.find((tag) => tag.key === "TYPE" && tag.value === "SOC")) {
          ...
          decoded_code !== void 0 && await stx_message.insert_on_tago(decoded_code, account_tago, Device, device[0].id, stu_message);
